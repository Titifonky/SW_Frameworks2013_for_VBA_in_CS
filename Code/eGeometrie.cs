...
namespace Framework
{
    ...
    public class ePoint : IePoint
    {
        ...
        private static readonly String cNOMCLASSE = typeof(ePoint).Name;
    ...
    public class eVecteur : IeVecteur
    {
        ...
        private static readonly String cNOMCLASSE = typeof(eVecteur).Name;
    ...
    public class eRepere : IeRepere
    {
        ...
        private static readonly String cNOMCLASSE = typeof(eRepere).Name;
    ...
    public class eRectangle : IeRectangle
    {
        ...
        private static readonly String cNOMCLASSE = typeof(eRectangle).Name;
    ...
    public class eZone : IeZone
    {
        ...
        private static readonly String cNOMCLASSE = typeof(eZone).Name;
